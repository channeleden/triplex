...
- **May 2024**: Removed the entire config being required to get started, install and open a component! That's it!
- **Jan 2025**: Added support for React DOM elements and components, unblocking using Triplex for 2D and composed 2D/3D components
...
- **Aug 2025**: Update the selection system to use AST paths for identification instead of line and column number
- **Oct 2025**: Triplex goes open source and moves to Poimandres

3 years, 1,200 commits, and 1 baby later and now we're here. I've always had intentions to build a company around Triplex, "build it and they'll come", but unfortunately never found product market fit. I've now [started a new job](https://x.com/dougesdev/status/1968239358210908267) at [Paper](https://paper.design) as founding product engineer and because of that have less time to dedicate to Triplex.

I want to see Triplex thrive and grow, and building completely in the open under Poimandres is the best place for that to happen. It's more like going home after all this time because that's where it started out from, after all.

## Where To From Here

This is a call to action for you dear reader. Where we go is going to be up to you, the community! What features do you want to see? What bugs need fixing? What should the roadmap look like? All of that is open for discussion and contribution, I'd absolutely love to see pull requests raised against Triplex and new features land from the community.

Here's some ideas of what we could do next:
